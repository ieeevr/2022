...
<div>
    ...
    <p>
        <div class="notice--info" style="background-color: $theme-yellow; color: $theme-text;">
            <b class="notice--text" style="background-color: $theme-yellow; color: $theme-text;" ><a href="https://tc.computer.org/vgtc/awards/vr-award-nominations/">Submit a Nomination</a></b>
        </div>
    </p>
